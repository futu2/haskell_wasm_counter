...
var promises = (() => ({}));
var setTimeout2, clearTimeout, setInterval, setImmediate, clearInterval, clearImmediate, _unrefActive = () => {};
var init_timers = __esm(() => {
  ({ setTimeout: setTimeout2, clearTimeout, setInterval, setImmediate, clearInterval, clearImmediate } = globalThis);
});

// node_modules/@runno/wasi/dist/main.js
var at = Object.defineProperty;
var ot = (i, t, e) => (t in i) ? at(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
...
class ct {
  constructor(t) {
    ...
    _(this, "debug");
    _(this, "isTTY");
    this.fs = (t == null ? undefined : t.fs) ?? {}, this.args = (t == null ? undefined : t.args) ?? [], this.env = (t == null ? undefined : t.env) ?? {}, this.stdin = (t == null ? undefined : t.stdin) ?? (() => null), this.stdout = (t == null ? undefined : t.stdout) ?? (() => {}), this.stderr = (t == null ? undefined : t.stderr) ?? (() => {}), this.debug = t == null ? undefined : t.debug, this.isTTY = !!(t != null && t.isTTY);
  }
}
...
class Et {
  ...
  hasDir(t, e) {
    return e === "." ? true : t.containsDirectory(e);
  }
  open(t, e, n, s) {
...
class W {
  constructor(t) {
    ...
    _(this, "context");
    _(this, "drive");
    _(this, "hasBeenInitialized", false);
  ...
  start(t, e = {}) {
    ...
    if (this.hasBeenInitialized = true, this.instance = t.instance, this.module = t.module, this.memory = e.memory ?? this.instance.exports.memory, "_initialize" in this.instance.exports)
  ...
  initialize(t, e = {}) {
    if (this.hasBeenInitialized)
      throw new X("This instance has already been initialized");
    if (this.hasBeenInitialized = true, this.instance = t.instance, this.module = t.module, this.memory = e.memory ?? this.instance.exports.memory, "_start" in this.instance.exports)
  ...
  args_get(t, e) {
    ...
    for (const s of this.context.args) {
      n.setUint32(t, e, true), t += 4;
      const a = new TextEncoder().encode(`${s}\x00`);
      new Uint8Array(this.memory.buffer, e, a.byteLength).set(a), e += a.byteLength;
    }
    return r.SUCCESS;
  }
  args_sizes_get(t, e) {
    const n = this.context.args, s = n.reduce((o, h) => o + new TextEncoder().encode(`${h}\x00`).byteLength, 0), a = new DataView(this.memory.buffer);
    return a.setUint32(t, n.length, true), a.setUint32(e, s, true), r.SUCCESS;
  }
  clock_res_get(t, e) {
    switch (t) {
      case I.REALTIME:
      ...
      case I.THREAD_CPUTIME_ID:
        return new DataView(this.memory.buffer).setBigUint64(e, BigInt(1e6), true), r.SUCCESS;
    }
    return r.EINVAL;
  }
  clock_time_get(t, e, n) {
    switch (t) {
      ...
      case I.PROCESS_CPUTIME_ID:
      case I.THREAD_CPUTIME_ID:
        return new DataView(this.memory.buffer).setBigUint64(n, N(/* @__PURE__ */ new Date), true), r.SUCCESS;
    }
    return r.EINVAL;
  }
  environ_get(t, e) {
  ...
  environ_sizes_get(t, e) {
    const n = this.envArray.reduce((a, o) => a + new TextEncoder().encode(`${o}\x00`).byteLength, 0), s = new DataView(this.memory.buffer);
    return s.setUint32(t, this.envArray.length, true), s.setUint32(e, n, true), r.SUCCESS;
  }
  proc_exit(t) {
    throw new Z(t);
  }
  ...
  fd_read(t, e, n, s) {
    ...
    return y({ bytesRead: f }), a.setUint32(s, f, true), c;
  }
  fd_write(t, e, n, s) {
    if (t === 0)
      return r.ENOTSUP;
  ...
  fd_prestat_get(t, e) {
    ...
    return s.setUint8(0, P.DIR), s.setUint32(4, n.byteLength, true), r.SUCCESS;
  }
  fd_pwrite(t, e, n, s, a) {
    if (t === 0)
      return r.ENOTSUP;
  ...
  fd_readdir(t, e, n, s, a) {
    ...
    return T.set(U), new DataView(this.memory.buffer).setUint32(a, U.byteLength, true), r.SUCCESS;
  }
  fd_renumber(t, e) {
  ...
  fd_seek(t, e, n, s) {
    ...
    return a !== r.SUCCESS || (y({ newOffset: o.toString() }), new DataView(this.memory.buffer).setBigUint64(s, o, true)), a;
  }
  ...
  fd_tell(t, e) {
    ...
    return n !== r.SUCCESS || new DataView(this.memory.buffer).setBigUint64(e, s, true), n;
  }
  ...
  path_open(t, e, n, s, a, o, h, f, c) {
    ...
    return v || (E.setUint32(c, rt, true), v);
  }
  ...
  poll_oneoff(t, e, n, s) {
    ...
    return new DataView(this.memory.buffer, s, 4).setUint32(0, n, true), r.SUCCESS;
  }
...
function R(i, t, e) {
  let n = Array(e);
  for (let s = 0;s < e; s++) {
    const a = i.getUint32(t, true);
    t += 4;
    const o = i.getUint32(t, true);
...
function _t(i) {
  ...
  switch (e) {
    ...
    case l.CLOCK:
      const s = n.getUint16(24, true), a = N(/* @__PURE__ */ new Date), o = n.getBigUint64(8, true), h = n.getBigUint64(16, true), f = s & et.SUBSCRIPTION_CLOCK_ABSTIME ? o : a + o;
      return {
        userdata: t,
        type: e,
...
function Q(i) {
  ...
  return e.setBigUint64(0, BigInt(0), true), e.setBigUint64(8, BigInt(j(i.path)), true), e.setUint8(16, i.type), e.setBigUint64(24, BigInt(1), true), e.setBigUint64(32, BigInt(i.byteLength), true), e.setBigUint64(40, N(i.timestamps.access), true), e.setBigUint64(48, N(i.timestamps.modification), true), e.setBigUint64(56, N(i.timestamps.change), true), t;
}
function J(i) {
  const t = new Uint8Array(G), e = new DataView(t.buffer);
  return e.setBigUint64(0, BigInt(0), true), e.setBigUint64(8, BigInt(j(i.path)), true), e.setUint8(16, i.type), e.setUint32(20, 1, true), e.setBigUint64(24, BigInt(i.byteLength), true), e.setBigUint64(32, N(i.timestamps.access), true), e.setBigUint64(40, N(i.timestamps.modification), true), e.setBigUint64(48, N(i.timestamps.change), true), t;
}
function Y(i, t, e) {
  const n = e ?? z, s = e ?? z, a = new Uint8Array(24), o = new DataView(a.buffer, 0, 24);
  return o.setUint8(0, i), o.setUint32(2, t, true), o.setBigUint64(8, n, true), o.setBigUint64(16, s, true), a;
}
function dt(i, t, e) {
  const n = new TextEncoder().encode(i), s = 24 + n.byteLength, a = new Uint8Array(s), o = new DataView(a.buffer);
  return o.setBigUint64(0, BigInt(e + 1), true), o.setBigUint64(8, BigInt(j(i)), true), o.setUint32(16, n.length, true), o.setUint8(20, t), a.set(n, 24), a;
}
function ut(i, t) {
  const e = new Uint8Array(32);
  e.set(i, 0);
  const n = new DataView(e.buffer);
  return n.setUint16(8, t, true), n.setUint16(10, l.CLOCK, true), e;
}
function q(i, t, e, n) {
  const s = new Uint8Array(32);
  s.set(i, 0);
  const a = new DataView(s.buffer);
  return a.setUint16(8, t, true), a.setUint16(10, e, true), a.setBigUint64(16, n, true), s;
}
function j(i, t = 0) {
...
var setImmediate2 = await (async () => {
  if (globalThis.setImmediate) {
    return globalThis.setImmediate;
  }
  if (globalThis.Deno) {
    try {
      return (await Promise.resolve().then(() => (init_timers(), exports_timers))).setImmediate;
    } catch {}
  }
...
var ghc_wasm_jsffi_default = (__exports) => {
  ...
  return {
    ...
    ZC0ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("progress"),
    ZC9ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("section"),
    ZC10ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("main"),
    ZC12ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("header"),
    ZC16ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("hgroup"),
    ZC18ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("ul"),
    ZC19ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("li"),
    ZC20ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("button"),
    ZC21ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("input"),
    ZC22ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("span"),
    ZC23ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("p"),
    ZC27ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("h2"),
    ZC28ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("h1"),
    ZC30ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: () => document.createElement("div"),
    ZC31ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1, $2, $3) => {
      $1.setAttribute($2, $3);
    },
    ZC33ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1) => (...args) => __exports.ghczuwasmzujsffiZC32ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC($1, ...args),
    ZC34ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1, $2, $3) => $1.addEventListener($2, $3),
    ZC36ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1) => $1.target.checked,
    ZC38ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1) => $1.replaceChildren(),
    ZC39ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1, $2) => $1.append($2),
    ZC40ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1, $2) => $1.textContent = $2,
    ZC42ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1) => $1.remove(),
    ZC43ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1) => $1.parentElement,
    ZC44ZCputuszm0zi1zi0zi1zma74cee4eb6c75ac45557424fc93aab1ef6945c021d36879aa96a47b08cb58c51ZCPutusziJSFFIZC: ($1) => document.getElementById($1),
...
// final.wasm
var final_default = "./final-c77n5rst.wasm";
...
var jsffiExports = {};
var wasm = await WebAssembly.instantiateStreaming(fetch(final_default), Object.assign({ ghc_wasm_jsffi: ghc_wasm_jsffi_default(jsffiExports) }, wasi.getImportObject()));
Object.assign(jsffiExports, wasm.instance.exports);
wasi.initialize(wasm, {
  ghc_wasm_jsffi: ghc_wasm_jsffi_default(jsffiExports)
});
